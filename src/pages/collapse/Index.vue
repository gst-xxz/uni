<template>
  <page-wraper>
    ...
    <demo-block title="基础用法" transparent>
      <pro-collapse ref="collapse" v-model="value1" @change="handleChange1">
        <pro-collapse-item v-for="(item, index) in itemList" :before-expend="index === 2 ? beforeExpend : undefined"
    ...
    <demo-block title="自定义title" transparent>
      <pro-collapse v-model="value7">
        <pro-collapse-item name="item1">
        ...
        <pro-collapse-item name="item2" disabled>
    ...
    <demo-block title="手风琴" transparent>
      <pro-collapse v-model="value2" :accordion="accordion" @change="handleChange2">
        <pro-collapse-item title="标签1" name="item1">这是一条简单的示例文字。</pro-collapse-item>
        <pro-collapse-item title="标签2" name="item2">
          这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。
        </pro-collapse-item>
        <pro-collapse-item title="标签3" name="item3">这是一条简单的示例文字。</pro-collapse-item>
      </pro-collapse>
    </demo-block>
    <demo-block title="禁用" transparent>
      <pro-collapse v-model="value3" @change="handleChange3">
        <pro-collapse-item title="标签1" name="item1">
          这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。
        </pro-collapse-item>
        <pro-collapse-item title="标签2" name="item2" disabled>这是一条简单的示例文字。</pro-collapse-item>
        <pro-collapse-item title="标签3" name="item3">这是一条简单的示例文字。</pro-collapse-item>
      </pro-collapse>
    </demo-block>

    <demo-block title="嵌套" transparent>
      <pro-collapse v-model="collapseRoot" @change="handleChange1">
        <pro-collapse-item v-for="item in 5" :key="item" :title="`标签${item}`" :name="`${item}`">
          <pro-collapse v-model="collapseList[item - 1]">
            <pro-collapse-item v-for="(item, index) in itemList" :key="index" :title="item.title" :name="item.name">
              {{ item.body }}
            </pro-collapse-item>
          </pro-collapse>
        </pro-collapse-item>
    ...
    <demo-block title="查看更多" transparent>
      <pro-collapse viewmore v-model="value4" @change="handleChange4">
        这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。这是一条简单的示例文字。
      </pro-collapse>
    </demo-block>
    <demo-block title="查看更多-行数显示设置" transparent>
      <pro-collapse viewmore v-model="value5" @change="handleChange5" :line-num="3">
    ...
    <demo-block title="查看更多-具名插槽" transparent>
      <pro-collapse viewmore v-model="value6" @change="handleChange6" use-more-slot custom-more-slot-class="more-slot">
...
import type { CollapseInstance } from '@/uni_modules/wot-design-uni/components/pro-collapse/typess'
import { ref } from 'vue'

  ...
  <page-wraper>
    ...
    <div style="margin: 20px 0">
      <wd-cell-group border>
        ...
        <wd-select-picker clearable label="必填" required v-model="value12" :columns="columns1"
          @confirm="handleConfirm12" />
        ...
        <wd-select-picker label="可清空" clearable type="radio" :show-confirm="false" v-model="value20" :columns="columns1"
          @confirm="handleConfirm2" />
      </wd-cell-group>
    </div>
    ...
    <demo-block title="自定义选择器" transparent>
      <div style="margin-left: 15px">
        <div style="margin-bottom: 10px">当前选中项: {{ customShow }}</div>

    ...
    <demo-block title="基础表单" transparent>
      <wd-form ref="form1" :model="model1">
        <wd-cell-group border>
          <wd-input label="歪比巴卜" label-width="100px" prop="value1" clearable v-model="model1.value1"
            placeholder="请输入歪比巴卜" :rules="[{ required: true, message: '请填写歪比巴卜' }]" />
          <wd-input label="沙卡拉卡" label-width="100px" prop="value2" show-password clearable v-model="model1.value2"
            placeholder="请输入沙卡拉卡" :rules="[{ required: true, message: '请填写沙卡拉卡' }]" />
        </wd-cell-group>
        <div class="footer">

<template>
  <page-wraper>
    ...
    <pro-curtain :value="value1" :src="img" :to="link" @close="handleClose1" :width="280"></pro-curtain>
    <pro-curtain :value="value2" :src="img" :to="link" close-position="top-left" :width="200"
      @close="handleClose2"></pro-curtain>
    <pro-curtain :value="value3" :src="img" :to="link" close-position="top" :width="200"
      @close="handleClose3"></pro-curtain>
    <pro-curtain :value="value4" :src="img" :to="link" close-position="top-right" :width="240"
      @close="handleClose4"></pro-curtain>
    <pro-curtain :value="value5" :src="img" :to="link" close-position="bottom-left" :width="240"
      @close="handleClose5"></pro-curtain>
    <pro-curtain :value="value6" :src="img" :to="link" close-position="bottom" :width="240"
      @close="handleClose6"></pro-curtain>
    <pro-curtain :value="value7" :src="img" :to="link" close-position="bottom-right" :width="240"
      @close="handleClose7"></pro-curtain>
    <pro-curtain :value="value8" :src="img" :to="link" close-position="bottom-right" :width="240" @close="handleClose8"
      :close-on-click-modal="true"></pro-curtain>
  </page-wraper>
</template>

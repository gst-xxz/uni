  ...
  <page-wraper>
    <view>
      <demo-block title="基本用法">
        <wd-notice-bar text="这是一条消息提示信息这是一条消息提示信息这是一条消息提示信息" prefix="volume-o" />
      </demo-block>
      ...
      <demo-block title="禁止滚动">
        <wd-notice-bar :scrollable="false" text="通知被禁或时段内消息屏蔽可能造成消…" prefix="volume-o"></wd-notice-bar>
      </demo-block>
      ...
      <demo-block title="可关闭的">
        <wd-notice-bar text="挂起后，电脑与手机均不会有新客户接入。挂起后，电脑与手机均不会有新客户接入。" closable prefix="volume-o" />
      </demo-block>
      ...
      <demo-block title="垂直滚动">
        <wd-notice-bar @click="handleClick" prefix="volume-o" direction="vertical" :text="textArray" :delay="3"
          custom-class="space" />
        <wd-notice-bar @click="handleClick" prefix="volume-o" direction="vertical" text="只有一条消息不会滚动" :delay="3"
          custom-class="space" />
      </demo-block>
    </view>
  </page-wraper>

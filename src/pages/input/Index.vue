<template>
  <page-wraper>
    <demo-block title="基本用法">
      <wd-input type="text" @input="handleInput" v-model="value" placeholder="请输入用户名" @change="handleChange"
        @blur="handleBlur" />
    </demo-block>
    ...
    <demo-block title="cell 类型" transparent>
      <pro-cell-group border>
        ...
        <wd-input type="text" label="清除、密码" v-model="value14" @input="handleInput" placeholder="密码" clearable
          show-password />

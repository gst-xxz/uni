...
<style>
.wot-theme-dark .wd-grid-item.is-border:before {
  background-color: var(--wot-dark-border-color, #3a3a3c);
}

.wot-theme-dark .wd-grid-item.is-border:after {
  background-color: var(--wot-dark-border-color, #3a3a3c);
}

.wot-theme-dark .wd-grid-item.is-first:after {
  background-color: var(--wot-dark-border-color, #3a3a3c);
}

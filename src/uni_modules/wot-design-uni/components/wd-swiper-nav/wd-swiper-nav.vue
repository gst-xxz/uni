<template>
  <view v-if="showControls" class="wd-swiper-nav__btn">
    <view class="wd-swiper-nav__btn--prev absolute top-1/2 -translate-y-1/2 rounded-full w-6 h-6 left-[15px]"
      @click="handleNav('prev')" />
    <view class="wd-swiper-nav__btn--next absolute top-1/2 -translate-y-1/2 rounded-full w-6 h-6 right-[15px]"

...
.wot-theme-dark .wd-textarea:after {
  background: #595959;
}

.wot-theme-dark .wd-textarea.is-not-empty:not(.is-disabled):after {
  background-color: #fff;
}

.wot-theme-dark .wd-textarea__value {
  background: #1b1b1b;
}
...
.wot-theme-dark .wd-textarea__inner::-webkit-input-placeholder {
...
.wot-theme-dark .wd-textarea__count {
  color: rgba(232, 230, 227, 0.8);
  background: transparent;
}

.wot-theme-dark .wd-textarea__count-current {
  color: #fff;
}

.wot-theme-dark .wd-textarea .wd-textarea__icon,
.wot-theme-dark .wd-textarea .wd-textarea__clear {
  color: #fff;
  background: transparent;
}

.wot-theme-dark .wd-textarea.is-cell {
  background-color: #1b1b1b;
}

.wot-theme-dark .wd-textarea.is-cell.is-border {
  position: relative;
}

.wot-theme-dark .wd-textarea.is-cell.is-border:after {
  position: absolute;
  display: block;
  content: '';
...
.wot-theme-dark .wd-textarea.is-disabled .wd-textarea__inner {
  color: #595959;
  background: transparent;
}

.wot-theme-dark .wd-textarea__label {
  color: #fff;
}

<template>
  <div :class="`wd-picker-view ${customClass}`" :style="customStyle">
    ...
    <div :style="`height: ${columnsHeight - 20}px;`">
      <picker-view mask-class="wd-picker-view__mask" indicator-class="wd-picker-view__roller"
        ...
        <picker-view-column v-for="(col, colIndex) in formatColumns" :key="colIndex" class="wd-picker-view-column">
          <div v-for="(row, rowIndex) in col" :key="rowIndex" :class="`wd-picker-view-column__item ${row['disabled'] ? 'wd-picker-view-column__item--disabled' : ''}  ${selectedIndex[colIndex] == rowIndex ? 'wd-picker-view-column__item--active' : ''
